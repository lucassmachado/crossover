...
public class HumidtyUpdater extends AtmosphericInformationUpdater {

	public HumidtyUpdater(AtmosphericInformation atmosphericInformation, DataPoint dataPoint) {
